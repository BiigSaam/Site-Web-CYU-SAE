<footer class="pied-page" role="contentinfo">
	...
	<li>•</li>
	<li><a class="lien-remonter" href="#haut" aria-label=""> Remonter </a></li>
	</ul>
	<p> © 2013–2021 - BUT MMI - CY Paris Université </p>
	<img class="logo-cyu" src="ressources/images/logo-cyu-couleur.png" alt="Logo de Cergy Université">
</footer>